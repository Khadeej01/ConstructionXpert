...
<head>
    ...
    <title>ConstructExpert | Créer une Ressource</title>
...
<section class="py-8">
    <div class="container mx-auto px-4">
        <a href="resources.jsp" class="inline-flex items-center text-dark font-medium mb-4 hover:text-accent">
            <i class="fas fa-arrow-left mr-2"></i> Retour à la liste des ressources
        </a>

        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="bg-primary text-white px-6 py-4 flex justify-between items-center">
                <h2 class="text-xl font-bold">Créer une Ressource</h2>
                ...
                <form action="ResourceServlet?action=create" method="post" onsubmit="return validateForm()">
                    <div class="mb-4">
                        ...
                        <select name="taskId" id="taskId" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent" required>
                            ...
                            %>
                            <option value="<%= tache.getId() %>">Tâche <%= tache.getId() %> - <%= tache.getDescription() != null ? tache.getDescription() : "Sans description" %></option>
                            <% } %>
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="quantite" id="quantite" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent" required>
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="bg-accent hover:bg-blue-600 text-white px-5 py-2 rounded-md flex items-center">
                            <i class="fas fa-plus-circle mr-2"></i> Créer la ressource
                        </button>
                    </div>
                </form>
            </div>
