...
<head>
    ...
    <title>ConstructExpert | Modifier un Projet</title>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="bg-primary text-white px-6 py-4 flex justify-between items-center">
                <h2 class="text-xl font-bold">Modifier un Projet</h2>
            ...
            <div class="p-6">
                <%
                    ...
                    if (projet == null) {
                %>
                <p class="text-dark">Projet non trouvé.</p>
                <% } else { %>
                <form action="ProjetServlet?action=update" method="post" onsubmit="return validateForm()">
                    <input type="hidden" name="id" value="<%= projet.getId() %>">
                    <div class="mb-4">
                        <label for="nom" class="block text-dark font-medium mb-2">Nom</label>
                        <input type="text" name="nom" id="nom" value="<%= projet.getNom() != null ? projet.getNom() : "" %>" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent min-h-[100px]" required><%= projet.getDescription() != null ? projet.getDescription() : "" %></textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="dateDebut" id="dateDebut" value="<%= projet.getDateDebut() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(projet.getDateDebut()) : "" %>" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="dateFin" id="dateFin" value="<%= projet.getDateFin() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(projet.getDateFin()) : "" %>" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="budget" id="budget" step="0.01" value="<%= projet.getBudget() %>" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-accent" required>
