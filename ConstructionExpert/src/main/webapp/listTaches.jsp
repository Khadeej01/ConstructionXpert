...
<head>
  ...
  <title>ConstructExpert | Liste des Tâches</title>
  ...
  <div class="container mx-auto px-4">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      <div class="bg-primary text-white px-6 py-4 flex justify-between items-center">
        <h2 class="text-xl font-bold">Liste des Tâches</h2>
      ...
      <div class="p-6">
        ...
        %>
        <p class="text-dark">Aucune tâche trouvée.</p>
        <% } else { %>
        <table class="w-full text-left border-collapse">
          ...
          <tr class="border-b hover:bg-gray-50">
            <td class="p-3"><%= t.getId() %></td>
            <td class="p-3"><%= t.getDescription() != null ? t.getDescription() : "Sans description" %></td>
            <td class="p-3"><%= t.getDateDebut() != null ? t.getDateDebut() : "Non définie" %></td>
            <td class="p-3"><%= t.getDateFin() != null ? t.getDateFin() : "Non définie" %></td>
            <td class="p-3"><%= projetNom %></td>
            <td class="p-3">
              <a href="TacheServlet?action=edit&id=<%= t.getId() %>" class="text-accent hover:text-blue-600 mr-2">
                <i class="fas fa-edit"></i> Modifier
              </a>
              <a href="TacheServlet?action=delete&id=<%= t.getId() %>" class="text-danger hover:text-red-700 mr-2" onclick="return confirm('Confirmer la suppression ?');">
                <i class="fas fa-trash-alt"></i> Supprimer
              </a>
              <a href="ResourceServlet?action=create&taskId=<%= t.getId() %>" class="text-success hover:text-green-700">
                <i class="fas fa-plus-circle"></i> Ajouter une ressource
              </a>
            </td>
          </tr>
          <% } %>
        ...
        <div class="mt-6 flex justify-end space-x-4">
          <a href="TacheServlet?action=create" class="bg-accent hover:bg-blue-600 text-white px-5 py-2 rounded-md flex items-center">
            <i class="fas fa-plus-circle mr-2"></i> Ajouter une tâche
          </a>
          <a href="ProjetServlet" class="bg-dark hover:bg-gray-700 text-white px-5 py-2 rounded-md flex items-center">
